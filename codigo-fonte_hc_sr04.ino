...
#define PINO_TRIGGER 12   // Pino responsável por emitir o pulso,→ ultrassônico
...
long tempo; // Armazena o tempo de ida e volta da onda,→ ultrassônica
...
// e do fato de o pulso percorrer o caminho de ida e volta 
